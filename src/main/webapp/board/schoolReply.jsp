...
function check(){
	...
	//가상경로 지정
	fm.action = "<%=request.getContextPath() %>/board/schoolReplyAction.do";
...
<body>
    ...
    <section id="main">
        ...
        <div id="notice-write">
            ...
            <form name="frm">
            <input type="text" name="bidx" value="<%=nv.getBidx() %>">
			<input type="text" name="originbidx" value="<%=nv.getOriginbidx()%>">
			<input type="text" name="depth" value="<%=nv.getDepth()%>">
			<input type="text" name="lvl" value="<%=nv.getLvl()%>">
                <tr>
                    <td>
                ...
                <tr>
                    <td colspan="2" height=400>
                        <textarea name="contents" placeholder="내용을 입력하세요." style="width: 100%; height: 100%"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>
