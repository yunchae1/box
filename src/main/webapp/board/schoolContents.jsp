...
<script type="text/javascript">
	...
	//가상경로 지정
	fm.action = "<%=request.getContextPath() %>/board/schoolContents.do";
...
<body>
    ...
    <section id="main">
        ...
        <div id="notice-view">
            ...
            <span>
                <p id="schedule"><a>2018년 신년인사회 일정.hwp</a></p>
                <img id="file" src="../images/file.png" alt="파일첨부" class="file">
                <br>
                <p><img id="profile" src="../images/사람.png" alt="회원사진">최아보카도 : 오 좋네요</p>
            </span>
            <hr>
            <button onclick="location.href='<%=request.getContextPath()%>/board/schoolModify.do?bidx=<%=nv.getBidx() %>'">수정</button>
            <button onclick="location.href='<%=request.getContextPath()%>/board/schoolDelete.do?bidx=<%=nv.getBidx() %>'">삭제</button>
            <button onclick="location.href='<%=request.getContextPath()%>/board/Notice.do'">목록</button>
        </div>
