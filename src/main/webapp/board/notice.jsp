    ...
    <section id="header">
        ...
        <div id="index">
            <ul>
                ...
                <li><a href="<%=request.getContextPath() %>/memberr/schoolnotice.do">공지사항</a></li>
    ...
    <section id="main">
        <div id="mindex">
            <ul>
                ...
                <li><a href="#"style="color:#BFB1AE;">공지사항</a></li>
                <li><a href="#">자유게시판</a></li>
                <li><a href="#">동창회개최</a></li>
                <li><a href="#">Q&A</a>
                    <div class="sub">
        ...
        <div id="notice">
            ...
            <button class="btn" onclick="location.href ='<%=request.getContextPath() %>/board/schoolWrite.do'">등록</button>
            <p>-총 **개의 글이 있습니다.</p>
            <div id="num">
                <p><a href="">처음</a> ◀</p>
                <a href="">1</a>
        ...
        <div>
            <table class="board-notice">
                ...
                <tr>
                   <td><%=nv.getBidx() %></td>
                   <th>
                     <a href="<%=request.getContextPath() %>/board/schoolContents.do?bidx=<%=nv.getBidx() %>"> <%=nv.getSubject() %></a></th>
                   <td><%=nv.getWriter() %></td>
